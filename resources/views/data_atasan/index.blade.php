...
<div class="card p-4 bg-white shadow-sm border-0">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="fw-bold text-primary">
            <i class="bi bi-people-fill me-2"></i> Daftar Atasan
        </h5>
                ...
                @forelse ($atasan as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            {{-- Tombol Edit --}}
                            <a href="{{ route('atasan.edit', $item->id) }}" class="btn btn-warning btn-sm">Edit</a>

                            {{-- Tombol Delete --}}
                            <form action="{{ route('atasan.destroy', $item->id) }}"
